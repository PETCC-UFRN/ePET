...
public interface ParticipanteRepository extends JpaRepository<Participante, Long> {
	...
	@Query(value = "SELECT u.id_participante, u.confirmado, u.espera, u.id_evento, u.id_pessoa, u.data_maxima FROM participante u INNER JOIN evento e ON e.id_evento = u.id_evento WHERE e.titulo LIKE %?1%", nativeQuery = true)
