...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		 ...
		 http.authorizeRequests()
				 ...
				 .antMatchers(HttpMethod.GET, "/api/anexos-evento/**").permitAll()
				 .antMatchers(HttpMethod.GET, "/api/anexos-noticias/**").permitAll()
				 ...
				 .antMatchers(HttpMethod.GET, "/api/pagseguro-notificacao/**").permitAll()
