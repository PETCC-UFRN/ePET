...
public class TutoriaController {
	...
	public ResponseEntity<?> getTutorias(Pageable pageable){
		Page<TutorialPresencial> tutorias = tutoriaService.buscar(pageable);
		if(tutorias.isEmpty()) {
	...
	public ResponseEntity<?> getTutoria(@PathVariable Long id){
		TutorialPresencial tutoria = tutoriaService.buscar(id);
		if(tutoria == null) {
	...
	public ResponseEntity<?> saveTutoria(@PathVariable Long id_petiano, @PathVariable Long id_disciplina, @RequestBody TutorialPresencial tutoria){
		TutorialPresencial salva = tutoriaService.salvar(id_petiano, id_disciplina, tutoria);
